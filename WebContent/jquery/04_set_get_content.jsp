...
<script>
	$(document).ready(function(){
		...
		$("#set_data").click(function(){
			...
			.append("<li>등산하기</li>").append("<li>영화하기</li>");
			
			//5. a태그 링크 형태로 d1에 추가
			$("#d1").html("<a href='http://www.naver.com'>Naver</a>");
			
			//6. img 형태로 추가 (인터프리터 형식으로 코드를 읽어내는걸 생각하자)
			$("#d2").html("<img src='http://localhost:9000/jhs_web_project/images/googlelogo.png'>");
			$("#d2 > img").css("width","200px");
		});
