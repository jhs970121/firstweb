$(document).ready(function(){
	const kobis = {"boxOfficeResult":
					...
					"dailyBoxOfficeList":[
					{"rnum":"1","rank":"1","rankInten":"0","rankOldAndNew":"OLD","movieCd":"20227890",
					"movieNm":"슈퍼 마리오 브라더스","openDt":"2023-04-26","salesAmt":"356316803","salesShare":"27.8",
					"salesInten":"-1398392724","salesChange":"-79.7","salesAcc":"9832497138","audiCnt":"35066",
					"audiInten":"-151261","audiChange":"-81.2","audiAcc":"990505","scrnCnt":"1201","showCnt":"4501"},
	...
	movie += "<table><tr><th>번호</th><th>랭킹</th><th>영화 제목</th><th>개봉일</th><th>랭킹 변동</th></tr>";
	for(movieMenu of kobis.boxOfficeResult.dailyBoxOfficeList){
		movie += "<tr>";
		movie += "<th>"+movieMenu.rnum+"</th>";
		movie += "<th>"+movieMenu.rank+"</th>";
		movie += "<th>"+movieMenu.movieNm+"</th>";
		movie += "<th>"+movieMenu.openDt+"</th>";
		movie += "<th>"+movieMenu.rankInten+"</th>";
		movie += "</tr>";
